...
<head>
	...
	<?php
		if (!empty($_POST['rua'])) {
           $rua = $_POST['rua'];
           echo 'O nome da rua que você digitou foi:'.$rua.'<br><br>';
        } else {
           echo "Você não digitou o nome da rua<br><br>";
        }
		if (!empty($_POST['bairro'])) {
           $bairro = $_POST['bairro'];
           echo 'O nome do bairro que você digitou foi:'.$bairro.'<br><br>';
        } else {
           echo "Você não digitou o nome do bairro<br><br>";
        }
		if (!empty($_POST['prob'])) {
           $prob = $_POST['prob'];
           echo 'Você relatou que existe o problema '.$prob.' na sua rua. <br><br>';
        } else {
           echo "Você não digitou nenhum problema<br><br>";
        }
